...
export default function Filter() {
    ...
    useEffect(()=>{
        fetch(`http://localhost:8080/zomato/restaurants/filter/${currentPage}`,{
            method:'POST',
    ...
    useEffect(()=>{
        fetch(`http://localhost:8080/zomato/locations`,{
            method: 'GET',
            headers:{'Content-type':'application/json' },
    ...
    <div>
        ...
        <div className="main">
            ...
            <div className="filter-block" style={{display: 'inline-block'}}>
                ...
                {/* location selector  */}
                <select name="Location" id="location" onChange={(e)=>handleLocation(e.target.value)}>
                ...
                <label htmlFor="cuisine" >
                    <input type="checkbox" name="North Indian" onChange={(e)=>handleCuisine(e)}/> North Indian <br/>
            ...
            <label htmlFor="sort">
                <input type="radio" name="sort" checked={filter.sort==1} onChange={()=> handleSort(1)} /> price low to high <br/>
